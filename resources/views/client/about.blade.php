            ...
            <div class="container">
                <div class="row align-items-center justify-content-center text-center">
                    ...
                    <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <p class="breadcrumb-custom"><a href="{{ route('landing') }}">Home</a> <span
            ...
            <div class="container">
                <div class="row mb-5">
                    ...
                    <div class="col-md-6 order-md-1" data-aos="fade">
                        ...
                        <p>PT Vifiera Minova Bersaudara was established since the year 2000, By H. Abdul Rachman. Since
                            then it has been providing various services such as Completely Buid Up Handling, Customs
                            Clearance and a Forwarding Agent. Which serves various clients throughout the years
                            <br>
                        </p>
                        <p class="mb-5">VMB itself is a trucking company with more than 20 years of experience. Since
                            2016, Due to its consistency and determination VMB has won various awards from competitions
                            held by Toyota TMMIN and still to this day.</p>

                        <div class="row">
                            <div class="col-md-12 mb-md-5 mb-0 col-lg-6">
                                <div class="unit-4">
                                    <div class="unit-4-icon mb-3 mr-4"><span
                                            class="text-primary flaticon-travel"></span></div>
                                    <div>
                                        <h3>Custom Clearance</h3>
                                        <p>One of our services that would be the act of moving goods through customs so
                                            they can enter the country</p>
                            ...
                            <div class="col-md-12 mb-md-5 mb-0 col-lg-6">
                                <div class="unit-4">
                                    ...
                                    <div>
                                        ...
                                        <p>We do our ground shipments by using our fleet of trucks in order to deliver
                                            the goods provided by our clients</p>
                                        <p class="mb-0"><a href="#">Learn More</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 mb-md-5 mb-0 col-lg-6">
                                <div class="unit-4">
                                    <div class="unit-4-icon mb-3 mr-4"><span class="text-primary flaticon-barn"></span>
                                    </div>
                                    <div>
                                        <h3>Warehousing</h3>
                                        <p>We also provide the ability for our clients to store their goods in a
                                            warehouse that we would rent from a trusted provider</p>
                                        <p class="mb-0"><a href="#">Learn More</a></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                        <div class="how-it-work-item">
                            ...
                            <div class="how-it-work-body">
                                <h2>Mission</h2>
                                <p class="mb-5">
                                    To become the best logistics partner which prioritize safety, accuracy, security and
                        ...
                        <div class="how-it-work-item">
                            ...
                            <div class="how-it-work-body">
                                ...
                                <ul class="ul-check list-unstyled white">
                                    ...
                                    <li class="text-white">To develop relations with support from professional human
                                        resources</li>
                                    <li class="text-white">Promote company growth in order to achieve employee welfare
                                    </li>
                                </ul>
                            </div>
                        </div>
