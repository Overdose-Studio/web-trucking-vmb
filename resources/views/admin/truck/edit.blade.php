    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <h1 class="panel-heading">Edit Truck</h1>
            </div>
        </div>
        <div class="card-body">
                ...
                <form action="{{ route('truck.update', $truck->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group @if ($errors->has('license_plate')) has-error @endif">
                        ...
                        @if ($errors->has('license_plate'))
                            <span class="help-block @if ($errors->has('license_plate')) text-danger @endif">
                    ...
                    <div class="form-group @if ($errors->has('brand')) has-error @endif">
                        ...
                        @if ($errors->has('brand'))
                            <span class="help-block @if ($errors->has('brand')) text-danger @endif">
                                {{ $errors->first('brand') }}
                            </span>
                        @endif
                    </div>
                    <div class="form-group @if ($errors->has('production_year')) has-error @endif">
                        ...
                        @if ($errors->has('production_year'))
                            <span class="help-block @if ($errors->has('production_year')) text-danger @endif">
                                {{ $errors->first('production_year') }}
                            </span>
                        @endif
                    </div>
                    <div class="form-group @if ($errors->has('last_maintenance')) has-error @endif">
                        ...
                        @if ($errors->has('last_maintenance'))
                            <span class="help-block @if ($errors->has('last_maintenance')) text-danger @endif">
                                {{ $errors->first('last_maintenance') }}
                            </span>
                        @endif
                    </div>
                    <div class="form-group @if ($errors->has('state_type')) has-error @endif">
                        ...
                        @if ($errors->has('state_type'))
                            <span class="help-block @if ($errors->has('state_type')) text-danger @endif">
                                {{ $errors->first('state_type') }}
                            </span>
                        @endif
                    </div>
                    <div class="form-group @if ($errors->has('state_evidence')) has-error @endif">
                        ...
                        <input type="file" accept="image/*" name="state_evidence" id="state_evidence" class="form-control" value="{{ $truck->state_evidence }}">
                        @if ($errors->has('state_evidence'))
                            <span class="help-block @if ($errors->has('state_evidence')) text-danger @endif">
