                ...
                <form action="{{ route('dtp.update', [$shipment->id, $dtp->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group {{ $errors->has('size') ? 'has-error' : '' }}">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="size" id="size1" value="20" {{ old('size') == 20 || $dtp->size == 20 ? 'checked' : '' }}>
                            <label class="form-check-label" for="size1">20"</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="size" id="size2" value="40" {{ old('size') == 40 || $dtp->size == 40 ? 'checked' : '' }}>
