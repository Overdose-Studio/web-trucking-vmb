                                                ...
                                                <tr>
                                                    <td class="content-block">
                                                        <table class="invoice">
                                                            <tbody>
                                                                <tr>
                                                                    {{-- <td>{{ $shipment->dailyTruckingPlan->truck->plate_number }}
                                                                        <br>Invoice #12345
                                                                        <br>{{ $shipment->dailyTruckingPlan->truck->plate_number }}
                                                                    </td> --}}
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <table class="invoice-items" cellpadding="0"
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <br>
                                                                                <tr>
                                                                                    <p>Trucking Cost TC2 Karawang</p>
                                                                                    <p>Tanggal : 31 Oktober 2022</p>
                                                                                </tr>
                                                                                <hr>
                                                                                <tr>
