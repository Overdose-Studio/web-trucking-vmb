            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <p class="card-text mb-0"><strong>Trip Fee:</strong> Rp {{ number_format($dta->price, 0, ',', '.') }}</p>
                    </div>
                </div>
                <div class="card-header">
                    <div class="d-flex align-items-center mb-2">
            ...
            <div class="card bg-secondary">
                ...
                <div class="card-header">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <p class="card-text mb-0"><strong>Trip Fee:</strong> Rp {{ number_format($selected->price, 0, ',', '.') }}</p>
                    </div>
                </div>
                <div class="card-header">
                    <div class="d-flex align-items-center mb-2">
